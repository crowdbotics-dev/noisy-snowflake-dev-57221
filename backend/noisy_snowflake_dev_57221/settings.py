"""
Django settings for noisy_snowflake_dev_57221 project.
...
ROOT_URLCONF = 'noisy_snowflake_dev_57221.urls'
...
WSGI_APPLICATION = 'noisy_snowflake_dev_57221.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_snowflake_dev_57221 API",
    "DESCRIPTION": "API documentation for noisy_snowflake_dev_57221 App",
    "VERSION": "v1",
}
