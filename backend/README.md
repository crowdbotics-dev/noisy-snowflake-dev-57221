...
## Project Structure
    ...
    ├── noisy_snowflake_dev_57221  # Django project configurations
...
1. Clone this repo and `cd noisy_snowflake_dev_57221`
...
2. Clone this repo and `cd noisy_snowflake_dev_57221`
